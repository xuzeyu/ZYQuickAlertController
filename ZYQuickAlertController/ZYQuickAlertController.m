...
+ (void)alertWithTitle:(NSString * _Nullable)title message:(NSString * _Nullable)message destructiveButtonTitle:(NSString * _Nullable)destructiveButtonTitle destructiveButtonHandler:(void (^ __nullable)(void))destructiveButtonHandler presentingViewController:(UIViewController * _Nullable)presentingViewController {
    [[ZYQuickAlertController shareInstance].delegate alertControllerWithTitle:title message:message defaultButtonTitle:nil defaultButtonHandler:nil destructiveButtonTitle:destructiveButtonTitle destructiveButtonHandler:destructiveButtonHandler cancelButtonTitle:nil cancelButtonHandler:nil presentingViewController:presentingViewController preferredStyle:UIAlertControllerStyleAlert];
}
...
+ (void)alertWithTitle:(NSString * _Nullable)title message:(NSString * _Nullable)message destructiveButtonTitle:(NSString * _Nullable)destructiveButtonTitle destructiveButtonHandler:(void (^ __nullable)(void))destructiveButtonHandler cancelButtonTitle:(NSString * _Nullable)cancelButtonTitle cancelButtonHandler:(void (^ __nullable)(void))cancelButtonHandler presentingViewController:(UIViewController * _Nullable)presentingViewController {
    [[ZYQuickAlertController shareInstance].delegate alertControllerWithTitle:title message:message defaultButtonTitle:nil defaultButtonHandler:nil destructiveButtonTitle:destructiveButtonTitle destructiveButtonHandler:destructiveButtonHandler cancelButtonTitle:cancelButtonTitle cancelButtonHandler:cancelButtonHandler presentingViewController:presentingViewController preferredStyle:UIAlertControllerStyleAlert];
}
...
+ (void)alertWithTitle:(NSString * _Nullable)title message:(NSString * _Nullable)message defaultButtonTitle:(NSString * _Nullable)defaultButtonTitle defaultButtonHandler:(void (^ __nullable)(void))defaultButtonHandler cancelButtonTitle:(NSString * _Nullable)cancelButtonTitle cancelButtonHandler:(void (^ __nullable)(void))cancelButtonHandler presentingViewController:(UIViewController * _Nullable)presentingViewController {
    [[ZYQuickAlertController shareInstance].delegate alertControllerWithTitle:title message:message defaultButtonTitle:defaultButtonTitle defaultButtonHandler:defaultButtonHandler destructiveButtonTitle:nil destructiveButtonHandler:nil cancelButtonTitle:cancelButtonTitle cancelButtonHandler:cancelButtonHandler presentingViewController:presentingViewController preferredStyle:UIAlertControllerStyleAlert];
}
...
+ (void)alertWithMessage:(NSString * _Nullable)message destructiveButtonTitle:(NSString * _Nullable)destructiveButtonTitle destructiveButtonHandler:(void (^ __nullable)(void))destructiveButtonHandler cancelButtonTitle:(NSString * _Nullable)cancelButtonTitle cancelButtonHandler:(void (^ __nullable)(void))cancelButtonHandler presentingViewController:(UIViewController * _Nullable)presentingViewController {
    [self alertWithTitle:@"提示" message:message destructiveButtonTitle:destructiveButtonTitle destructiveButtonHandler:destructiveButtonHandler cancelButtonTitle:cancelButtonTitle cancelButtonHandler:cancelButtonHandler presentingViewController:presentingViewController];
}
...
+ (void)alertWithMessage:(NSString * _Nullable)message defaultButtonTitle:(NSString * _Nullable)defaultButtonTitle defaultButtonHandler:(void (^ __nullable)(void))defaultButtonHandler destructiveButtonTitle:(NSString * _Nullable)destructiveButtonTitle destructiveButtonHandler:(void (^ __nullable)(void))destructiveButtonHandler cancelButtonTitle:(NSString * _Nullable)cancelButtonTitle cancelButtonHandler:(void (^ __nullable)(void))cancelButtonHandler presentingViewController:(UIViewController * _Nullable)presentingViewController {
    [self alertWithTitle:@"提示" message:message defaultButtonTitle:defaultButtonTitle defaultButtonHandler:defaultButtonHandler destructiveButtonTitle:destructiveButtonTitle destructiveButtonHandler:destructiveButtonHandler cancelButtonTitle:cancelButtonTitle cancelButtonHandler:cancelButtonHandler presentingViewController:presentingViewController];
}
...
- (void)alertControllerWithTitle:(NSString * _Nullable)title message:(NSString * _Nullable)message defaultButtonTitle:(NSString * _Nullable)defaultButtonTitle defaultButtonHandler:(void (^ __nullable)(void))defaultButtonHandler destructiveButtonTitle:(NSString * _Nullable)destructiveButtonTitle destructiveButtonHandler:(void (^ __nullable)(void))destructiveButtonHandler cancelButtonTitle:(NSString * _Nullable)cancelButtonTitle cancelButtonHandler:(void (^ __nullable)(void))cancelButtonHandler presentingViewController:(UIViewController * _Nullable)presentingViewController preferredStyle:(UIAlertControllerStyle)preferredStyle {
    if ([ZYQuickAlertController shareInstance].delegate != [ZYQuickAlertController shareInstance] && [[ZYQuickAlertController shareInstance].delegate respondsToSelector:@selector(alertControllerWithTitle:message:defaultButtonTitle:defaultButtonHandler:destructiveButtonTitle:destructiveButtonHandler:cancelButtonTitle:cancelButtonHandler:presentingViewController:preferredStyle:)]) {
        [[ZYQuickAlertController shareInstance].delegate alertControllerWithTitle:title message:message defaultButtonTitle:defaultButtonTitle defaultButtonHandler:defaultButtonHandler destructiveButtonTitle:destructiveButtonTitle destructiveButtonHandler:destructiveButtonHandler cancelButtonTitle:cancelButtonTitle cancelButtonHandler:cancelButtonHandler presentingViewController:presentingViewController preferredStyle:preferredStyle];
        return;
    }
